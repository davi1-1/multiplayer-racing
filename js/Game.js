class Game {
  ...
  showLeaderboard(){
    ...
    if(players[0].rank === 1 || players[0].rank === 0 && players[1].rank === 0){
      var linha1 = players[0].rank + "&emsp;" + players[0].name +"&emsp;" + players[0].score;
      var linha2 = players[1].rank + "&emsp;" + players[1].name +"&emsp;" + players[1].score;
    }

    if(players[1].rank === 1 ){
      var linha1 = players[1].rank + "&emsp;" + players[1].name +"&emsp;" + players[1].score;
      var linha2 = players[0].rank + "&emsp;" + players[0].name +"&emsp;" + players[0].score;
    }

    this.leader1.html(linha1)
    this.leader2.html(linha2)
  }
